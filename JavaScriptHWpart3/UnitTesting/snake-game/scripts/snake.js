...
var snakeGame = (function () {
    ...
    var obstacleFillColor = "#990000";
    var obstacleStrokeColor = "#660000";
    ...
    var SnakeGame = Class.create({
        ...
        checkCollisions: function () {
            ...
            //moves the snake on the other end whenit leaves on one end
            for (i = 0; i < this.snake.size; i += 1) {
                var piece = this.snake.pieces[i];
                if (piece.position.x < 0 || piece.position.x + piece.size > this.maxX ||
                    piece.position.y < 0 || piece.position.y + piece.size > this.maxY)
                {
        ...
        start: function () {
            ...
            if (this.snakeTimer) {
                ...
                //task 3 - on restart no die handlers wera added
                this.snake.addDieHandler(function (result) {
                    console.log("Result is: " + result.score);
                    clearInterval(self.snakeTimer);
                });
